...
hi Normal		guifg=#F4F3F1	ctermfg=white guibg=#424242 ctermbg=black
hi NonText		guifg=#F4F3F1	ctermfg=white
hi comment		guifg=lightgray		ctermfg=lightgray	gui=italic
hi constant		guifg=#F4F3F1		ctermfg=white
hi string guifg=lightgray ctermfg=lightgray
...
hi delimiter guifg=lightgray ctermfg=lightgray gui=NONE cterm=NONE
...
hi StatusLine    cterm=none gui=none    guifg=black ctermfg=black guibg=white ctermbg=white
